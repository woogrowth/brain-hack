...
let state = {
  ...
  // signup
  signupStep: 0,
  signupData: {job:'',country:'KR',username:'',password:'',pwConfirm:'',nickname:'',agreePrivacy:false,agreeThird:false,agreePush:false,gender:''},
  signupErrors: {},
  // login
  ...
  // ── 다크모드 / 글씨크기 ──
  darkMode: ls.get('bh_darkMode', false),
...
function applyTheme() {
  ...
  document.documentElement.style.setProperty('--body-size', sizes[state.fontSize] || '15px');
  if(state.darkMode) {
