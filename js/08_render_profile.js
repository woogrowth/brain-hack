function renderProfile() {
  ...
  // Header card
  const headerCard = h('div',{style:{background:'linear-gradient(135deg,#060e18 60%,#0a1a24)',border:'1px solid var(--cyan)33',padding:'28px',marginBottom:'12px',position:'relative',overflow:'hidden'}},
    ...
    h('div',{style:{display:'flex',alignItems:'center',gap:'20px',marginBottom:'20px'}},
      ...
      h('div',{style:{flex:'1'}},
        ...
        h('div',{style:{display:'flex',gap:'6px',flexWrap:'wrap',alignItems:'center'}},
          rankBadge(u.xp||0),
          u.equipped?.title ? h('span',{style:{fontFamily:'var(--mono)',fontSize:'9px',color:'var(--yellow)',border:'1px solid #ffcc0044',padding:'1px 6px',background:'#ffcc0011'}},u.equipped.title) : null
        )
      )
    ),
