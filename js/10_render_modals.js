...
function renderSignupModal() {
  ...
  if(s===0) content = h('div',{},
    ...
    h('select',{className:'inp',style:{marginBottom:'18px'},value:d.race||'prefer_not_to_say',onChange:e=>up('race',e.target.value)},
    ...
    field('아이디 (6자 이상)',errs.username||'',h('input',{className:'inp',placeholder:'brain_user01',value:d.username,onInput:e=>{state.signupData={...state.signupData,username:e.target.value}}})),
